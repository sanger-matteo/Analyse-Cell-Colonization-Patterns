...
| Example of results generated | Description |
| ---| ---|
| ![Figure 1](/Voronoi.png) | Voronoi diagram created using the script |
| ![Figure 1](/Colony_density.png) | Example of visualization of cell density using the script |
